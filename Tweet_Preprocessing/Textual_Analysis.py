...
#clean tweets of @s, URLS, newlines, emojis, hashtags, numbers, 
#unnecessary puntucation (ie does not mark end of a sentence)
...
#date participant completed the survey
...
#correct for local time zone and account for time of year 
...
#get whether a person was diagnosed by a physician with depression
...
#has a person reported a depressive episode in the past year
...
#recruitment through FYP, surveygizmo, or Clickworker
...
for i in range(0,len(file_names)):
    ...
    '''
    ######################################################################
    #local time zone correction for indiviudal tweets 
    ...
    #clean tweets of unnecessary characters 
    ...
    #only keep participants with at least 5 days of Tweets and at least 50% of all Tweets from their 
    #account are in English 
