...
Participant_info = Dates = pd.read_csv('Data/Participant_Data/FYP_Twitter_Participants.csv')

#get twitter handles from file names 
file_names = list(Participant_info['Twitter_Handle'])

#create random ids here 
Participant_info['Id'] = alpha_numeric_string(len(file_names))
...
Participant_info.to_csv('Participant_Data/FYP_Twitter_Participants.csv',index = False)