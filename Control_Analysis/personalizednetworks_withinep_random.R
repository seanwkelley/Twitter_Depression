...
write.table(t(model1_coeff),file = "Data/Results/all_tweets/model1_coeff_randnet.csv",append = T,row.names = F,col.names = F,sep=",")
write.table(t(model2_coeff),file = "Data/Results/all_tweets/model2_coeff_randnet.csv",append = T,row.names = F,col.names = F,sep=",")
