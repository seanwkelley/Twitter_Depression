#--------------------------------------------------
#1. Figure 2: Personalised network connectivity is associated with self-reported depression severity  
#2. Table S2: Depression severity remains associated with increased network connectivity after controlling for number of days 
#--------------------------------------------------
