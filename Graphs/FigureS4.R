...
#Personalised strength centralities of networks without including 3rd person pronouns 
...
zscore_ci$Sentiment <- c("Neg. Emo.", "Pos. Emo.", "1st Pers. Sing.",
                         "1st Pers. Pl.","2nd Pers.","Swear","Article","Negate")

zscore_ci$Sentiment <- factor(zscore_ci$Sentiment, levels = zscore_ci$Sentiment[order(zscore_ci$Sentiment,decreasing = F)])
...
png("Figures/FigureS4.png", units="cm", width=70, height=30, res=600)
combined
dev.off()
